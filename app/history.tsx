...
export default function HistoryScreen() {
  ...
  return (
    ...
    <Text style={styles.emptySubtext}>Сыграй и увидишь результаты здесь!</Text>
   </View>
        ) : (
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 36, fontWeight: 'bold', color: '#00ff88', marginTop: 40, textAlign: 'center' },
  subtitle: { fontSize: 18, color: '#aaa', textAlign: 'center', marginBottom: 20 },
  ...
  emptySubtext: { fontSize: 18, color: '#666', textAlign: 'center', marginTop: 12 },
});